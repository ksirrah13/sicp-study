#lang sicp
(#%require "op-table.scm")
(#%require "global-shared.scm")
(#%provide (all-defined))
...
(define (install-polar-package)
  ...
  (define (equal c1 c2)
    (and (equ? (magnitude c1) (magnitude c2))
         (equ? (angle c1) (angle c2))))
  (define (zero c)
    (=zero? (magnitude c)))
  (define (make-from-real-imag x y) 
